        ...
        <div className="relative h-[70vh] md:h-[85vh] max-w-6xl mx-auto rounded-2xl overflow-hidden shadow-lg">
          ...
          <div className="absolute inset-0 flex items-center justify-center px-6">
            <div className="text-center text-white max-w-3xl">
              <h1 className="serif text-4xl md:text-6xl font-bold leading-tight">Spaces that tell stories — curated with soul and balance.</h1>
              <p className="mt-6 text-lg md:text-2xl opacity-90">A fusion of modern minimalism and traditional craft. Interiors layered with texture, warmth and intention.</p>
              <a href="#portfolio" className="inline-block mt-8 bg-white text-warmblack py-3 px-6 rounded-full shadow hover:scale-105 transition">View My Work</a>
            </div>
          </div>
